...
class QueryEntityRanking(EntityRanking):
    ...
    def __init__(self,
                 ...
                 mention_freq,
                 mention2pem: Dict,
                 p_t_thetae_method='jelinek',  # Smoothing method
        ...
        self.p_t_thetae_method = p_t_thetae_method
    ...
    def p_q_e(self, text_tokens, entityid):
        ...
        for term, c_term in terms.items():
            if self.p_t_thetae_method =='jelinek':
                ...
                if p_t_Eps == 0 or p_t_e == 0:
                    continue
            elif self.p_t_thetae_method == 'bayesian':
                p_t_theta,p_t_Eps =self.p_t_thetae_bayesian(entityid, term)
    ...
    def p_t_thetae_bayesian(self, entityid, term,  mu=100000):
        """ P (t|θe)
        `entity_catalog`: A dict of entities and descriptions

        Bayesian smooting
        Eq 3.10 Balog
        P (t|θe) =c(t;e) + μP (t|E)/le + μ
        ...
        p_t_thetae = (cte + mu * p_t_Eps) / (le + mu)
        return p_t_thetae, p_t_Eps
